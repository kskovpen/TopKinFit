...
//   float c = par[FPARAM_mWLep_TOPTOPLEPHAD]*par[FPARAM_mWLep_TOPTOPLEPHAD]/2.+LeptonPx*PxNu1+LeptonPy*PyNu1;
   ...
   *KINFIT::kfit::TopTopPzAbs = fabs(totPzLep) + fabs(totPzHad);
   ...
   float NonBJet1PxProb = (! (*IsParFixed)[FPARAM_NonBJet1Px_TOPTOPLEPHAD] && ! isDeltaFuncPDFNonBJetPx) ? getProb(hPDFNonBJetPx.get(), (par[FPARAM_NonBJet1Px_TOPTOPLEPHAD]-PxNonBJet1)/par[FPARAM_NonBJet1Px_TOPTOPLEPHAD], maxPDFNonBJetPx, xminPDFNonBJetPx, xmaxPDFNonBJetPx) : 1.0;
   float NonBJet1PyProb = (! (*IsParFixed)[FPARAM_NonBJet1Py_TOPTOPLEPHAD] && ! isDeltaFuncPDFNonBJetPy) ? getProb(hPDFNonBJetPy.get(), (par[FPARAM_NonBJet1Py_TOPTOPLEPHAD]-PyNonBJet1)/par[FPARAM_NonBJet1Py_TOPTOPLEPHAD], maxPDFNonBJetPy, xminPDFNonBJetPy, xmaxPDFNonBJetPy) : 1.0;
   float NonBJet1PzProb = (! (*IsParFixed)[FPARAM_NonBJet1Pz_TOPTOPLEPHAD] && ! isDeltaFuncPDFNonBJetPz) ? getProb(hPDFNonBJetPz.get(), (par[FPARAM_NonBJet1Pz_TOPTOPLEPHAD]-PzNonBJet1)/par[FPARAM_NonBJet1Pz_TOPTOPLEPHAD], maxPDFNonBJetPz, xminPDFNonBJetPz, xmaxPDFNonBJetPz) : 1.0;
   float NonBJet1PtProb = (! (*IsParFixed)[FPARAM_NonBJet1Pt_TOPTOPLEPHAD] && ! isDeltaFuncPDFNonBJetPt) ? getProb(hPDFNonBJetPt.get(), (par[FPARAM_NonBJet1Pt_TOPTOPLEPHAD]-PtNonBJet1)/par[FPARAM_NonBJet1Pt_TOPTOPLEPHAD], maxPDFNonBJetPt, xminPDFNonBJetPt, xmaxPDFNonBJetPt) : 1.0;
   float NonBJet1EtaProb = (! (*IsParFixed)[FPARAM_NonBJet1Eta_TOPTOPLEPHAD] && ! isDeltaFuncPDFNonBJetEta) ? getProb(hPDFNonBJetEta.get(), (par[FPARAM_NonBJet1Eta_TOPTOPLEPHAD]-EtaNonBJet1)/par[FPARAM_NonBJet1Eta_TOPTOPLEPHAD], maxPDFNonBJetEta, xminPDFNonBJetEta, xmaxPDFNonBJetEta) : 1.0;
   float NonBJet1PhiProb = (! (*IsParFixed)[FPARAM_NonBJet1Phi_TOPTOPLEPHAD] && ! isDeltaFuncPDFNonBJetPhi) ? getProb(hPDFNonBJetPhi.get(), (par[FPARAM_NonBJet1Phi_TOPTOPLEPHAD]-PhiNonBJet1)/par[FPARAM_NonBJet1Phi_TOPTOPLEPHAD], maxPDFNonBJetPhi, xminPDFNonBJetPhi, xmaxPDFNonBJetPhi) : 1.0;

   float NonBJet2PxProb = (! (*IsParFixed)[FPARAM_NonBJet2Px_TOPTOPLEPHAD] && ! isDeltaFuncPDFNonBJetPx) ? getProb(hPDFNonBJetPx.get(), (par[FPARAM_NonBJet2Px_TOPTOPLEPHAD]-PxNonBJet2)/par[FPARAM_NonBJet2Px_TOPTOPLEPHAD], maxPDFNonBJetPx, xminPDFNonBJetPx, xmaxPDFNonBJetPx) : 1.0;
   float NonBJet2PyProb = (! (*IsParFixed)[FPARAM_NonBJet2Py_TOPTOPLEPHAD] && ! isDeltaFuncPDFNonBJetPy) ? getProb(hPDFNonBJetPy.get(), (par[FPARAM_NonBJet2Py_TOPTOPLEPHAD]-PyNonBJet2)/par[FPARAM_NonBJet2Py_TOPTOPLEPHAD], maxPDFNonBJetPy, xminPDFNonBJetPy, xmaxPDFNonBJetPy) : 1.0;
   float NonBJet2PzProb = (! (*IsParFixed)[FPARAM_NonBJet2Pz_TOPTOPLEPHAD] && ! isDeltaFuncPDFNonBJetPz) ? getProb(hPDFNonBJetPz.get(), (par[FPARAM_NonBJet2Pz_TOPTOPLEPHAD]-PzNonBJet2)/par[FPARAM_NonBJet2Pz_TOPTOPLEPHAD], maxPDFNonBJetPz, xminPDFNonBJetPz, xmaxPDFNonBJetPz) : 1.0;
   float NonBJet2PtProb = (! (*IsParFixed)[FPARAM_NonBJet2Pt_TOPTOPLEPHAD] && ! isDeltaFuncPDFNonBJetPt) ? getProb(hPDFNonBJetPt.get(), (par[FPARAM_NonBJet2Pt_TOPTOPLEPHAD]-PtNonBJet2)/par[FPARAM_NonBJet2Pt_TOPTOPLEPHAD], maxPDFNonBJetPt, xminPDFNonBJetPt, xmaxPDFNonBJetPt) : 1.0;
   float NonBJet2EtaProb = (! (*IsParFixed)[FPARAM_NonBJet2Eta_TOPTOPLEPHAD] && ! isDeltaFuncPDFNonBJetEta) ? getProb(hPDFNonBJetEta.get(), (par[FPARAM_NonBJet2Eta_TOPTOPLEPHAD]-EtaNonBJet2)/par[FPARAM_NonBJet2Eta_TOPTOPLEPHAD], maxPDFNonBJetEta, xminPDFNonBJetEta, xmaxPDFNonBJetEta) : 1.0;
   float NonBJet2PhiProb = (! (*IsParFixed)[FPARAM_NonBJet2Phi_TOPTOPLEPHAD] && ! isDeltaFuncPDFNonBJetPhi) ? getProb(hPDFNonBJetPhi.get(), (par[FPARAM_NonBJet2Phi_TOPTOPLEPHAD]-PhiNonBJet2)/par[FPARAM_NonBJet2Phi_TOPTOPLEPHAD], maxPDFNonBJetPhi, xminPDFNonBJetPhi, xmaxPDFNonBJetPhi) : 1.0;
